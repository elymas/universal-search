// Package naver — error sentinels and Retry-After parsing.
// REQ-ADP8-003: parseRetryAfter implements RFC 7231 §7.1.3.
// REQ-ADP8-008: ErrInvalidQuery sentinel for empty/whitespace query rejection.
package naver
...
var ErrInvalidQuery = errors.New("naver: query text empty or whitespace-only")

// maxRetryAfter caps the Retry-After duration at 60 seconds per REQ-ADP8-003.
const maxRetryAfter = 60 * time.Second

// defaultRetryAfter is used when the Retry-After header is absent or
// malformed. 5 seconds per REQ-ADP8-003.
