const config = {
  ...
  head: (
    <>
      ...
      <meta name="description" content="Universal Search - Hybrid AI-powered search engine documentation" />
    ...
    components: {
      Copyright: () => (
        <div style={{ display: 'flex', gap: '1rem' }}>
          ...
          <a href="https://github.com/elymas/universal-search/blob/main/CHANGELOG.md" target="_blank" rel="noopener noreferrer">
            Changelog
          </a>
        </div>
      ),
